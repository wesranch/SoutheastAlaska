...
dir <- "F:/seAlaska/landis/"
ic <- readLines(paste0(dir, "simulations/North_Test/North/AKCarbon_IC_File-JL_01052023.txt"))
...
write.csv(ic_new, paste0(dir, "simulations/North_Test/North/AKCarbon_IC_WR_04082025.csv"), row.names = FALSE)
